...
$('.product_item input[type="checkbox"]').on('change', function () {
    $('.product_item input[type="checkbox"]').not(this).prop('checked', false);
});
...
jQuery(document).ready(function ($) {
    ...
    $(".nav-tabs .nav-item:first-of-type a.nav-link").addClass("active");
