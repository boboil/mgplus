...
AdminSection::registerModel( Slide::class, function ( ModelConfiguration $model )
{
    ...
    $model->onDisplay( function ()
    {
        ...
        $display->setColumns(
            ...
            AdminColumn::image( 'image' )->setLabel( 'Слайд' ) ->setWidth( '100px' )
        )->paginate( 25 );
        return $display;
    } );
    $model->onCreateAndEdit( function ( $id = null )
    {
        ...
        $display->setTabs(function() use ($id) {
            ...
            $form->addHeader(AdminFormElement::columns()
                ->addColumn([
                    AdminFormElement::image('image', 'Слайд'),
                ], 12)
                ->addColumn([
